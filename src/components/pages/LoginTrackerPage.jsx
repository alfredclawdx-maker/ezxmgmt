  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p style={{ color: G.faint, fontSize: 10.5, letterSpacing: '0.42em', marginTop: 4 }}>
      ...
      >
        ...
        <p style={{ color: G.dim, fontSize: 13, textAlign: 'center' }}>
          Login tracker feature is being developed
        </p>
      </div>
    </div>
  );
